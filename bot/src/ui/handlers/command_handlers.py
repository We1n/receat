...
class CommandHandlers:
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_text = (
            ...
            "💰 *Работа с ценами:*\n"
            "/setprice - Установить цену на продукт\n"
            "/price <продукт> - Посмотреть цену продукта\n"
            "/prices - Список всех цен\n\n"
            "💡 *Советы:*\n"
            "• Используйте меню для навигации\n"
            "• Добавляйте свои рецепты и продукты\n"
            "• Устанавливайте цены для сравнения по магазинам\n"
            "• Система автоматически находит лучшую цену\n\n"
            "❓ *Нужна помощь?*\n"
